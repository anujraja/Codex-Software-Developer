# Canonical Skill: slack-gif-creator

Generated at: `2026-03-18T08:03:51+00:00`
Translation status: `english`
Canonical ID: `skill--slack-gif-creator`

## Summary
Toolkit for creating animated GIFs optimized for Slack, with validators for size constraints and composable animation primitives. This skill applies when users request animated GIFs or emoji animations for Slack from descriptions like "make me a GIF for Slack of X doing Y".

## Provenance
- `ComposioHQ/awesome-codex-skills` `master` `slack-gif-creator/SKILL.md` ([raw](https://raw.githubusercontent.com/ComposioHQ/awesome-codex-skills/master/slack-gif-creator/SKILL.md))

## Metadata
- Tags: `skill, skill-md, slack-gif-creator`
- Languages: `c`
- Systems: `linear, slack`
- Jobs: `skill-md, slack-gif-creator`
- Roles: ``

## Steps
1. **Animation Primitives** - Composable building blocks for motion (shake, bounce, move, kaleidoscope)
2. **Helper Utilities** - Optional functions for common needs (text, colors, effects)
3. **Validators** - Check if a GIF meets Slack's requirements
4. Automatic color quantization
5. Avoid gradients
6. Color limit: 128-256
7. Color limit: 32-48
8. Duplicate frame removal
9. Duration: 1-2s
10. Duration: 2-5s
11. Keep designs simple
12. Limit to 10-15 frames total
13. Max size: 64KB (strict limit)
14. Max size: ~2MB
15. Optimal dimensions: 128x128
16. Optimal dimensions: 480x480
17. Typical FPS: 10-12
18. Typical FPS: 15-20
19. Use 32-48 colors maximum
20. Validate file size frequently

## Instructions
Source: ComposioHQ/awesome-codex-skills (master) :: slack-gif-creator/SKILL.md
