# Canonical Skill: langsmith-fetch

Generated at: `2026-03-18T08:06:29+00:00`
Translation status: `english`
Canonical ID: `skill--langsmith-fetch`

## Summary
Debug LangChain and LangGraph agents by fetching execution traces from LangSmith Studio. Use when debugging agent behavior, investigating errors, analyzing tool calls, checking memory operations, or examining agent performance. Automatically fetches recent traces and analyzes execution patterns. Requires langsmith-fetch CLI installed.

## Provenance
- `ComposioHQ/awesome-codex-skills` `master` `langsmith-fetch/SKILL.md` ([raw](https://raw.githubusercontent.com/ComposioHQ/awesome-codex-skills/master/langsmith-fetch/SKILL.md))

## Metadata
- Tags: `langsmith-fetch, skill, skill-md`
- Languages: `c, javascript`
- Systems: ``
- Jobs: `langsmith-fetch, skill-md`
- Roles: ``
...
3. Duration: 15.1s
4. Duration: 2.3s
5. Error: "Neo4j connection timeout"
6. Failed at: search_nodes tool
7. Tokens: 1,245
8. Tools: recall_memories, create_entities
9. Tools: store_memory
10. ⏱️ Execution times
11. ⚠️ Any errors or failures
12. ✅ Number of traces found
13. ❌ "Check for errors" or "Why did it fail?"
14. 🐛 "Debug my agent" or "What went wrong?"
15. 💰 Token usage
16. 💾 "Analyze memory operations" or "Check LTM"
17. 📊 "Review agent performance" or "Check token usage"
18. 🔍 "Show me recent traces" or "What happened?"
19. 🔧 "What tools were called?" or "Show execution flow"
20. 🛠️ Tools that were called

## Instructions
Source: ComposioHQ/awesome-codex-skills (master) :: langsmith-fetch/SKILL.md
