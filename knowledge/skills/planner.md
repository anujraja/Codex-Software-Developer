# Canonical Skill: planner

Generated at: `2026-03-18T08:03:51+00:00`
Translation status: `english`
Canonical ID: `skill--planner`

## Summary
>

## Provenance
- `am-will/codex-skills` `main` `skills/planner/SKILL.md` ([raw](https://raw.githubusercontent.com/am-will/codex-skills/main/skills/planner/SKILL.md))

## Metadata
- Tags: `planner, skill, skills`
...
5. Ask any helpful question
6. Auth & permissions
7. Challenges & edge cases
8. Core requirements
9. Data & integrations
10. Dependencies and frameworks
11. Goals & success criteria
12. Performance & reliability
13. Platforms & environments
14. Related components
15. Scope & non‑goals
16. Security/performance/UX considerations
17. Similar existing implementations
18. Tech constraints
19. Testing & validation
20. Users & core workflows

## Instructions
Source: am-will/codex-skills (main) :: skills/planner/SKILL.md
# Planner Agent
