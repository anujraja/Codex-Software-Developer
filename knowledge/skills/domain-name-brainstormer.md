# Canonical Skill: domain-name-brainstormer

Generated at: `2026-03-18T08:06:29+00:00`
Translation status: `english`
Canonical ID: `skill--domain-name-brainstormer`

## Summary
Generates creative domain name ideas for your project and checks availability across multiple TLDs (.com, .io, .dev, .ai, etc.). Saves hours of brainstorming and manual checking.

## Provenance
- `ComposioHQ/awesome-codex-skills` `master` `domain-name-brainstormer/SKILL.md` ([raw](https://raw.githubusercontent.com/ComposioHQ/awesome-codex-skills/master/domain-name-brainstormer/SKILL.md))

## Metadata
- Tags: `domain-name-brainstormer, skill, skill-md`
- Languages: `c`
- Systems: ``
- Jobs: `domain-name-brainstormer, skill-md`
- Roles: `developer`

## Steps
1. **Branding Insights**: Explains why certain names work well
2. **Checks Availability**: Verifies which domains are actually available across multiple TLDs
3. **Generates Creative Names**: Creates relevant, memorable domain options
...
6. **Understands Your Project**: Analyzes what you're building and who it's for
7. Creating a personal brand or portfolio site
8. Finding available alternatives when your first choice is taken
9. Launching a product or service
10. Rebranding an existing project
11. Registering a domain for a side project
12. Starting a new project or company
13. codeshare.com (Taken, est. $2,500)
14. snippets.com (Taken, premium domain)
15. ✓ codebox.io - Tech-forward
16. ✓ codeclip.com - Short and snappy
17. ✓ devpaste.com - Developer-focused
18. ✓ sharecode.app - Descriptive
19. ✓ snippet.dev - Perfect extension for developers
20. ✓ snippetbox.com - Clear, memorable, available!

## Instructions
Source: ComposioHQ/awesome-codex-skills (master) :: domain-name-brainstormer/SKILL.md
