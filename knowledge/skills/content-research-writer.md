...
Canonical ID: `skill--content-research-writer`

## Summary
Assists in writing high-quality content by conducting research, adding citations, improving hooks, iterating on outlines, and providing real-time feedback on each section. Transforms your writing process from solo effort to collaborative partnership.

## Provenance
- `ComposioHQ/awesome-codex-skills` `master` `content-research-writer/SKILL.md` ([raw](https://raw.githubusercontent.com/ComposioHQ/awesome-codex-skills/master/content-research-writer/SKILL.md))

## Metadata
- Tags: `content-research-writer, skill, skill-md`
- Languages: ``
- Systems: `slack`
- Jobs: `content-research-writer, skill-md`
- Roles: `writer`

## Steps
1. **Citation Management**: Adds and formats references properly
2. **Collaborative Outlining**: Helps you structure ideas into coherent outlines
3. **Get section feedback**:
4. **Hook Improvement**: Strengthens your opening to capture attention
5. **Improve the hook**:
6. **Iterative Refinement**: Helps you improve through multiple drafts
7. **Refine and polish**:
8. **Research Assistance**: Finds relevant information and adds citations
9. **Research and add citations**:
10. **Section Feedback**: Reviews each section as you write
11. **Start with an outline**:
12. **Voice Preservation**: Maintains your writing style and tone
13. Creating educational content or tutorials
14. Drafting thought leadership pieces
15. Getting section-by-section feedback while writing
16. Improving hooks and introductions
17. Producing technical documentation with sources
18. Researching and writing case studies
19. Writing blog posts, articles, or newsletters
20. Writing with proper citations and references

## Instructions
Source: ComposioHQ/awesome-codex-skills (master) :: content-research-writer/SKILL.md
