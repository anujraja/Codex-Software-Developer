# Canonical Skill: project-skill-audit

Generated at: `2026-03-18T08:06:29+00:00`
Translation status: `english`
Canonical ID: `skill--project-skill-audit`
...
## Provenance
- `Dimillian/Skills` `main` `project-skill-audit/SKILL.md` ([raw](https://raw.githubusercontent.com/Dimillian/Skills/main/project-skill-audit/SKILL.md))

## Metadata
- Tags: `project-skill-audit, skill, skill-md`
- Languages: `c`
- Systems: ``
- Jobs: `project-skill-audit, skill-md`
- Roles: ``

## Steps
1. Build the memory/session path first.
2. Compare project-local skills against recurring work.
3. Map the current project surface.
4. Read project past sessions in this order.
5. Scan existing project-local skills before suggesting anything new.
6. `.agents/skills`
7. `.codex/skills`
8. `skills`
9. current `cwd`
10. important module or file names
11. memory index: `$CODEX_HOME/memories/MEMORY.md` or `~/.codex/memories/MEMORY.md`
12. raw sessions: `$CODEX_HOME/sessions/` or `~/.codex/sessions/`
13. recurring ownership boundaries
14. repeated failure shields
15. repeated root-cause categories
16. repeated validation sequences
17. repo basename
18. repo name
19. rollout summaries: `$CODEX_HOME/memories/rollout_summaries/`
20. workflows that repeatedly require the same repo-specific context

## Instructions
Source: Dimillian/Skills (main) :: project-skill-audit/SKILL.md
# Project Skill Audit
