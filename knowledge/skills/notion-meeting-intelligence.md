# Canonical Skill: notion-meeting-intelligence

Generated at: `2026-03-18T09:12:23+00:00`
Translation status: `english`
Canonical ID: `skill--notion-meeting-intelligence`

## Summary
Prepare meeting materials with Notion context and Codex research; use when gathering context, drafting agendas/pre-reads, and tailoring materials to attendees.

## Provenance
- `ComposioHQ/awesome-codex-skills` `master` `notion-meeting-intelligence/SKILL.md` ([raw](https://raw.githubusercontent.com/ComposioHQ/awesome-codex-skills/master/notion-meeting-intelligence/SKILL.md))

## Metadata
- Tags: `notion-meeting-intelligence, skill, skill-md`
- Languages: `c`
- Systems: `mcp, notion`
- Jobs: `notion-meeting-intelligence, skill-md`
- Roles: ``

## Steps
1. 1:1 → one-on-one template.
2. Add the Notion MCP:
3. Ask for objective, desired outcomes/decisions, attendees, duration, date/time, and prior materials.
4. Capture blockers/risks and open questions up front.
5. Confirm meeting goal, attendees, date/time, and decisions needed.
6. Decision/approval → decision template.
7. Draft agenda/pre-read in Notion with `Notion:notion-create-pages`, embedding source links and owner/timeboxes.
8. Enable remote MCP client:
9. Enrich with Codex research (industry insights, benchmarks, risks) and update the page with `Notion:notion-update-page` as plans change.
10. Gather context: search with `Notion:notion-search`, then fetch with `Notion:notion-fetch` (prior notes, specs, OKRs, decisions).
11. Ideation → brainstorming template.
12. Log in with OAuth:
13. Pick the right template via `reference/template-selection-guide.md` (status, decision, planning, retro, 1:1, brainstorming).
14. Planning (sprint/project) → planning template.
15. Retro/feedback → retrospective template.
16. Search Notion for relevant docs, past notes, specs, and action items (`Notion:notion-search`), then fetch key pages (`Notion:notion-fetch`).
17. Set `[features].rmcp_client = true` in `config.toml` **or** run `codex --enable rmcp_client`
18. Status/update → status template.
19. `codex mcp add notion --url https://mcp.notion.com/mcp`
20. `codex mcp login notion`

## Instructions
Source: ComposioHQ/awesome-codex-skills (master) :: notion-meeting-intelligence/SKILL.md
