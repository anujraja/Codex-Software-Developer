# Canonical Skill: parallel-task

Generated at: `2026-03-18T09:12:23+00:00`
Translation status: `english`
Canonical ID: `skill--parallel-task`

## Summary
>

## Provenance
- `am-will/codex-skills` `main` `skills/parallel-task/SKILL.md` ([raw](https://raw.githubusercontent.com/am-will/codex-skills/main/skills/parallel-task/SKILL.md))

## Metadata
- Tags: `parallel-task, skill, skills`
- Languages: ``
- Systems: ``
- Jobs: `parallel-task, skills`
- Roles: `orchestrator`

## Steps
1. **Plan file**: The markdown plan to read
2. **Task subset** (optional): Specific task IDs to run
3. **depends_on** list (from `- **depends_on**: [...]`)
4. **description**: "Implement task [ID]: [name]"
5. **prompt**: Use template below
6. Build task list
7. Constraints: [risks from plan]
8. Default to TDD RED phase first using a `tdd_test_writer` subagent:
...
15. Pass task context and acceptance criteria.
16. Plan: [filename]
17. Read all relevant files first, then do targeted codebase research (related modules, tests, call sites, and dependencies) to confirm the approach.
18. Read the working plan and fully understand this task before coding.
19. Related tasks: [tasks that depend on or are depended on by this task]
20. Task ID and name

## Instructions
Source: am-will/codex-skills (main) :: skills/parallel-task/SKILL.md
