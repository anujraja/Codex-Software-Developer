...
## Provenance
- `ComposioHQ/awesome-codex-skills` `master` `connect-apps/SKILL.md` ([raw](https://raw.githubusercontent.com/ComposioHQ/awesome-codex-skills/master/connect-apps/SKILL.md))

## Metadata
- Tags: `connect-apps, skill, skill-md`
- Languages: `c`
- Systems: `github, notion, slack`
- Jobs: `connect-apps, skill-md`
- Roles: `developer`

## Steps
1. **"Need to authorize"** → Click the OAuth link Claude provides, then say "done"
2. **"Plugin not found"** → Make sure you ran `/plugin install composio-toolrouter`
3. **Action failed** → Check you have permissions in the target app
4. Action executes and returns result
5. Ask for your free API key (get one at [platform.composio.dev](https://platform.composio.dev/?utm_source=Github&utm_content=AwesomeSkills))
6. Composio Tool Router finds the right tool
7. Configure Claude's connection to 1000+ apps
8. First time? You'll authorize via OAuth (one-time)
9. Take about 60 seconds
10. You ask Claude to do something

## Instructions
Source: ComposioHQ/awesome-codex-skills (master) :: connect-apps/SKILL.md
# Connect Apps
