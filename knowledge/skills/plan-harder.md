# Canonical Skill: plan-harder

Generated at: `2026-03-18T08:06:29+00:00`
Translation status: `english`
Canonical ID: `skill--plan-harder`

## Summary
>

## Provenance
- `am-will/codex-skills` `main` `skills/plan-harder/SKILL.md` ([raw](https://raw.githubusercontent.com/am-will/codex-skills/main/skills/plan-harder/SKILL.md))

## Metadata
- Tags: `plan-harder, skill, skills`
- Languages: `typescript`
- Systems: ``
- Jobs: `plan-harder, skills`
- Roles: `architect`

## Steps
1. **Analyze the request:**
2. **Investigate the codebase:**
3. **Overview**: Brief summary and approach
4. **Sprints**: Logical phases that build on each other
5. **Tasks**: Specific, actionable items within sprints
6. Architecture and patterns
7. Build on prior sprint work
8. Challenges and edge cases
9. Core requirements
10. Dependencies and frameworks
11. Edge case handling
12. Include demo/verification checklist
13. Priorities (critical vs nice-to-have)
14. Related components
15. Result in **demoable, runnable, testable** increment
16. Scope boundaries (in/out of scope)
17. Security/performance/UX considerations
18. Similar existing implementations
19. Success criteria
20. Technology/architectural constraints

## Instructions
Source: am-will/codex-skills (main) :: skills/plan-harder/SKILL.md
# Planner Agent
