...
## Provenance
- `am-will/codex-skills` `main` `prompts/parallel-task.md` ([raw](https://raw.githubusercontent.com/am-will/codex-skills/main/prompts/parallel-task.md))

## Metadata
- Tags: `parallel-task-md, prompt, prompts`
- Languages: ``
- Systems: ``
- Jobs: `parallel-task-md, prompts`
- Roles: ``
...
3. **description**: “Implement task [ID]: [task name]”
4. **prompt**: Use the template below
5. Build a list of tasks to execute.
6. Dependencies and prerequisites for this task
7. Extract all task subsections (e.g., `### Task 1.1:`).
8. Find the sprint/phase section (e.g., `## Sprint 1:` or `## Phase 2:`).
9. For each task, extract:
10. For each task, launch a subagent with:
11. Full task content (description, location, acceptance criteria, validation, etc.)
12. If not provided, ask the user which sprint/phase to run.
13. If not, launch subagents sequentially and note that in the summary.
14. If parallel execution is supported by the environment, launch subagents in parallel.
15. Key constraints or risks called out in the plan
16. Plan file name and sprint/phase
17. Related tasks in the same sprint that affect this work
18. Relevant overview/goals from the plan
19. Task ID (e.g., "1.1", "2.3")
20. Task name/title

## Instructions
Source: am-will/codex-skills (main) :: prompts/parallel-task.md
