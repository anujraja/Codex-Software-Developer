# Canonical Prompt: agent-activation-prompts

Generated at: `2026-03-18T08:03:51+00:00`
Translation status: `english`
Canonical ID: `prompt--agent-activation-prompts`

## Summary
# 🎯 NEXUS Agent Activation Prompts > Ready-to-use prompt templates for activating any agent within the NEXUS pipeline. Copy, customize the `[PLACEHOLDERS]`, and deploy. --- ## Pipeline Controller ### Agents Orchestrat...

## Provenance
- `msitarzewski/agency-agents` `main` `strategy/coordination/agent-activation-prompts.md` ([raw](https://raw.githubusercontent.com/msitarzewski/agency-agents/main/strategy/coordination/agent-activation-prompts.md))

## Metadata
- Tags: `coordination, prompt, strategy`
- Languages: `javascript`
- Systems: ``
- Jobs: `coordination, strategy`
- Roles: `developer, orchestrator, tester`

## Steps
1. Activate Evidence Collector for QA validation
2. Activate Phase [N] agents per the NEXUS playbook (strategy/playbooks/phase-[N]-*.md)
3. Assign to appropriate developer agent (see assignment matrix)
4. Context continuity — every handoff carries full context
5. Enforce quality gates before any phase advancement
6. Evidence over claims — require proof for all quality assessments
7. Fail fast, fix fast — escalate after 3 retries
8. First-pass QA rate
9. IF FAIL (attempt < 3): Send QA feedback to developer, retry
10. IF FAIL (attempt = 3): Escalate — reassign, decompose, or defer
11. IF PASS: Mark complete, move to next task
12. Manage all handoffs using the NEXUS Handoff Template
13. Maximum 3 retries per task before escalation
14. No phase advances without passing its quality gate
15. Read the project specification thoroughly
16. Report status at every phase boundary
17. Run Dev↔QA loops: Developer implements → Evidence Collector tests → PASS/FAIL decision
18. Tasks completed / total
19. Track all tasks with the NEXUS Pipeline Status Report format
20. Wait for implementation completion

## Instructions
Source: msitarzewski/agency-agents (main) :: strategy/coordination/agent-activation-prompts.md
